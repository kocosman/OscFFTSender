...
public class SoundAnalyzer {
  ...
  public void analyze(){
    ...
    arrayCopy(soundSpectrum,(int)soundFocusOffset,soundFocusSpectrum,0,(int)soundFocusSize);
    arrayCopy(soundSpectrumLPF,(int)soundFocusOffset,soundFocusSpectrumLPF,0,(int)soundFocusSize);
